"""
Random Forest implementation for Algorithm Runtime Prediction.

This module builds on top of a patched version of Scikit-learn to enable the
uniform random sampling of exact split points whilst fitting, as originally 
described by [1].

References
----------
[1] Hutter, F., Xu, L., Hoos, H. H., & Leyton-Brown, K. (2014). 
       "Algorithm Runtime Prediction: Methods & Evaluation."
       Artificial Intelligence, 206, 79-111.
"""
...
class RuntimePredictionRandomForest(RandomForestRegressor):
    ...
    Frank Hutter et al. (2014) in "Algorithm Runtime Prediction: Methods & Evaluation".
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        if self.criterion != "squared_error":
            warnings.warn(
                "Variance calculation relies on the 'squared_error' "
