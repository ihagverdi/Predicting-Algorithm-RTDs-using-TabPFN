'''
ExperimentConfig is a dataclass that serves as a container for all hyperparameters related to an experiment. This design choice helps to avoid long function signatures and keeps the code organized. Each attribute of the ExperimentConfig class corresponds to a specific hyperparameter that can be adjusted for different experimental setups.
'''
